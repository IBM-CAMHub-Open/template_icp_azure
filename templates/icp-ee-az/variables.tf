...
variable "registry_username" {
  description = "Username for the private docker registry the ICP image will be grabbed from"
  default     = ""
}

variable "registry_password" {
  description = "Password for the private docker registry the ICP image will be grabbed from"
  default     = ""
}
...
variable "docker_image_location" {
  description = "Location of Docker image tarball. Assumes stored as azure blob"
  default     = ""
}
...
variable "install_verbosity" {
  description = "ICP Install verbosity"
  default     = ""
}
